...
public class CommonDialog extends Dialog implements android.view.View.OnClickListener{
	...
	ChartDialogBtnListener listener; 
	View contentView;

	public interface ChartDialogBtnListener{
	...
	public void setButtomBtn(ChartDialogBtnListener listener, String btn1name, String btn2name){

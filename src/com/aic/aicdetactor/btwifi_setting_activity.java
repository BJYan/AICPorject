    ...
    private final Handler mHandler = new Handler() {  
        ...
        public void handleMessage(Message msg) {  
            ...
            case Bluetooth.MESSAGE_READ:  
               ...
               // Toast.makeText(getApplicationContext(), "readMessage: "+readMessage , Toast.LENGTH_SHORT).show();  
            ...
            case Bluetooth.MESSAGE_TOAST:  
                Toast.makeText(getApplicationContext(), Bluetooth.TOAST, Toast.LENGTH_SHORT).show();  
                break;  
            }  
        }  
    };  
